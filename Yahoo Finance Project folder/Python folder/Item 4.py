...
# average closing share price during the last 5 days that is 2% to 20% above the last
...
yf.pdr_override()
newFile=r'C:\Users\nicky\OneDrive\Desktop\Output4.xlsx'
writer = pd.ExcelWriter(newFile, engine="xlsxwriter")
startrow=1
headers = pd.DataFrame(columns=['Stock', 'Name', "Last 5 days avg closing price",
                                "Is 2% to 20% above last 10 Days",
                                "Is 2% to 20% above last 20 Days",
                                "Is 2% to 20% above last 50 Days",
                                "Is 2% to 20% above last 200 Days"])
...
for i in tickers.index[:10]:
    ...
    print("last 5 days ACP: " +  str(last_5_days_avg_price))
    ...
    try:                
        ...
        for period in list_of_periods:
            ...
            #print("last " + str(period) + " days ACP: " + str(avg_closing_price_for_period))
            ...
            if (0.02 <= percentage_difference <= 0.2):
